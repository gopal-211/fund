    ...
    <div>
      ...
      <div className="mt-[60px] flex lg:flex-row flex-col gap-5">
        ...
        <div className="flex-1">
          ...
          <div className="mt-[20px] flex flex-col p-4 bg-blue-100 rounded-[10px]">
            <p className="font-epilogue fount-medium text-[20px] leading-[30px] text-center text-black font-bold">
              Fund the campaign
            </p>
